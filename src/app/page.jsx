...
export default function Home() {
  ...
  const fetchAll = useCallback(async () => {
    ...
    setError(null)
    try {
      const [a, p, m, td] = await Promise.all([
  ...
  return (
    <div className="app-shell">
      <Nav activeTab={activeTab} setActiveTab={setActiveTab} hasAttention={hasAttention} />
      <main className="tab-content">
        ...
        {activeTab === 'team' && <TeamTab analysts={analysts} setAnalysts={setAnalysts} loading={loading} showToast={showToast} />}
        ...
        {activeTab === 'ai' && <AICoach analysts={analysts} projects={projects} meetings={meetings} todos={todos} showToast={showToast} />}
      </main>
